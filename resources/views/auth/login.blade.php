...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container">
      ...
      <div class="d-none d-md-block mx-lg-4">
              <h1 class="logo-text text-primary">Propelond</h1>
               <p class="login-intro">Connect with friends and the world around you on Propelond.</p>
              </div>
                  ...
                  <form method="POST" action="{{ route('login') }}">
                       ...
                       <div class="d-grid gap-2">
                            ...
                            @if (Route::has('register'))
                             <a href="{{ route('register') }}" class="btn btn-link text-decoration-none text-dark">Create New Account</a>
                            @endif
