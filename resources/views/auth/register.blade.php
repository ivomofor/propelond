...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container">
      <div class="d-flex align-items-center justify-content-center py-5">
            <div class="register-card py-2">
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <h4 class="name-text text-center">Sign up</h4>
                            <p class="text-center">It’s quick and easy.</p>
                         <!-- Name  -->
                        <div class="row mb-3" id="user-name">
                        ...
                        <div class="row mb-3" id="user-dob">
                            <div> <div class="col-md-12 my-2 my-lg-0">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Enter your birthday') }}</label>
                        ...
                        <!-- password -->
                        <div class="row mb-3" id="user-password">
                            ...
                            @if (Route::has('register'))
                             <a href="{{ route('login') }}" class="btn btn-link text-decoration-none text-center">Already a memeber? Login</a>
                            @endif
                            </div>
                        </div>
